...
--
-- Host: localhost
-- Generation Time: Jan 03, 2022 at 04:05 PM
...
INSERT INTO `nghiphep` (`id`, `name`, `reason`, `songay`, `maPB`, `status`) VALUES
(16, 'Nguyễn Hưng Hoài Nam', 'xin chào xếp em muốn nghỉ để dưỡng sức', 7, 'software', 'approved'),
(17, 'Trần Thị Kiều', 'em muốn đi nghỉ mát để xả stress ạ', 7, 'software', 'approved'),
(18, 'Trần Thị Kiều', 'em xin được nghỉ để để tang', 8, 'software', 'approved'),
(19, 'Nguyễn Hưng Hoài Nam', 't xin nghỉ bệnh cúm', 1, 'software', 'approved');
...
(17, 'Nguyễn Hưng Hoài Nam', 'nvhoainam', '$2y$10$YvUaFF43UfYDM9Y6SoIKnum8IvPcxg3rdosbHH2mW1S3VMReTC8Xm', 'software', 'nhân viên', 'images/8c7e9fa06948d3b136dabfba06b33bac.JPG', 8, 12, 1, '12345678', 'nam@example.com', 1234567890, '12 đường Đồng Tiền'),
