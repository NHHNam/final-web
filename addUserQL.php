...
<body>
    ...
    <a href="api/dsQuanLy.php"><i class="fas fa-arrow-left ml-5 mt-5 p-1"></i></a>
    <?php 
        require_once("conn.php");
        ...
        if(isset($_POST["addUser"])){
            ...
            $sql2 = "INSERT INTO quanly(username) VALUES(?)";
            ...
            if($success && $success2){
                header("Location: api/dsQuanLy.php");
            }
        }
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input type="file" class="form-control" name="hinhuser">
                            </div>
                            <div class="form-group">
