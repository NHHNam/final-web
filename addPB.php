                ...
                <div class="card-body">
                    <form novalidate method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group form-group">
                            ...
                            <input class="input-group-text" type="text" name="namePB" placeholder="Enter name of phongban">
                        </div>
                        ...
                        <div class="input-group form-group">
                            ...
                            <input class="input-group-text" type="text" name="maPB" placeholder="enter maPB of phongban">
                        </div>
