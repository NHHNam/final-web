...
<body>
    ...
    <div class="table-responsive">
            <table border="1" class="table table-lg table-striped text-center">
                ...
                <tbody>
                    <?php 
                        $stt = 1;
                        $sql1 = "SELECT * FROM quanly q ,user u where q.username = u.username";
    ...
    <button class="btn btn-primary"><a style="color: white; text-decoration: none;" href="../addUserQL.php">Thêm nhân viên</a></button>
